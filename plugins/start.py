...
async def start_command(client: Client, message: Message):
    ...
    owner_id = OWNER_ID
    logging.warning(f"The user {id} is using the bot now") 
    # Check if the user is the owner
    if id == owner_id:

        await message.reply("You're my owner additional actions can be done")
        ...
        if "verify_" in message.text:
            ...
            #await client.send_message(chat_id=LOG_ID, text=f"User : {mention} | {id}\n {get_verify_status(id)}", )
            ...
            SD = await message.reply_text("𝐹𝑖𝑙𝑒𝑠 𝑤𝑖𝑙𝑙 𝑏𝑒 𝑑𝑒𝑙𝑒𝑡𝑒𝑑 𝑖𝑛 {SECONDS} 𝑠𝑒𝑐𝑜𝑛𝑑𝑠 𝑡𝑜 𝑎𝑣𝑜𝑖𝑑 𝑐𝑜𝑝𝑦𝑟𝑖𝑔ℎ𝑡 𝑖𝑠𝑠𝑢𝑒𝑠. 𝑃𝑙𝑒𝑎𝑠𝑒 𝑓𝑜𝑟𝑤𝑎𝑟𝑑 𝑡ℎ𝑒 𝑓𝑖𝑙𝑒𝑠.")
            ...
            if IS_VERIFY and not verify_status['is_verified']:
                ...
                btn = [
                    [InlineKeyboardButton("𝐶𝑙𝑖𝑐𝑘 𝐻𝑒𝑟𝑒", url=link)],
                    [InlineKeyboardButton('𝐻𝑜𝑤 𝑡𝑜 𝑢𝑠𝑒 𝑡ℎ𝑒 𝑏𝑜𝑡', url=TUT_VID)]
                ]
                await message.reply(f"𝑌𝑜𝑢𝑟 𝐴𝑑𝑠 𝑡𝑜𝑘𝑒𝑛 𝑖𝑠 𝑒𝑥𝑝𝑖𝑟𝑒𝑑, 𝑟𝑒𝑓𝑟𝑒𝑠ℎ 𝑦𝑜𝑢𝑟 𝑡𝑜𝑘𝑒𝑛 𝑎𝑛𝑑 𝑡𝑟𝑦 𝑎𝑔𝑎𝑖𝑛. 🏚️🗝️.\n\n𝑇𝑜𝑘𝑒𝑛 𝑇𝑖𝑚𝑒𝑜𝑢𝑡: {get_exp_time(VERIFY_EXPIRE)}\n\n𝑊ℎ𝑎𝑡 𝑖𝑠 𝑡ℎ𝑒 𝑡𝑜𝑘𝑒𝑛?\n\n𝑇ℎ𝑖𝑠 𝑖𝑠 𝑎𝑛 𝑎𝑑𝑠 𝑡𝑜𝑘𝑒𝑛. 𝐼𝑓 𝑦𝑜𝑢 𝑝𝑎𝑠𝑠 1 𝑎𝑑, 𝑦𝑜𝑢 𝑐𝑎𝑛 𝑢𝑠𝑒 𝑡ℎ𝑒 𝑏𝑜𝑡 𝑓𝑜𝑟 {get_exp_time(VERIFY_EXPIRE)} 𝑎𝑓𝑡𝑒𝑟 𝑝𝑎𝑠𝑠𝑖𝑛𝑔 𝑡ℎ𝑒 𝑎𝑑. 💌", reply_markup=InlineKeyboardMarkup(btn), protect_content=False, quote=True)
